...
(function () {
  ...
  // Only auto-redirect on citizen-login.html, not citizen-register.html
  if (existing && !window.location.pathname.includes('register')) {
  ...
  // Which auth page are we on? citizen-login.html → "login", citizen-register.html → "register".
